    ...
    <div className="relative flex items-center justify-center w-full my-4">
      <div id="poda" className="relative flex items-center justify-center group w-full max-w-[314px]">
        ...
        <div id="main" className="relative group w-full">
          <input placeholder="Search archives..." type="text" name="text" className="bg-[#010201] border-none w-full max-w-[301px] h-[56px] rounded-lg text-white px-[59px] text-lg focus:outline-none placeholder-gray-400 font-mono tracking-widest text-xs uppercase" />
